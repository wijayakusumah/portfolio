import { IconBackground, IconBrandGithub, IconBrandInstagram, IconBrandLinkedin, IconBrandTwitter, IconBrandYoutube } from '@tabler/icons-react';
import { ActionIcon, Container, Group, Text, Image, Grid } from '@mantine/core';

export function Footer() {

  return (
    <footer style={{ marginTop: '80px', backgroundColor: 'light-dark(var(--mantine-color-gray-0), var(--mantine-color-dark-6))', borderTop: '1px solid light-dark(var(--mantine-color-gray-2), var(--mantine-color-dark-5))' }}>
      <Container size={'lg'}>
      <Grid visibleFrom="lg" mb={'md'} style={{paddingTop: 'calc(var(--mantine-spacing-xl) * 1.5)'}}>
    ...
    <Grid.Col span={{ base: 12, lg: 6 }}>
      ...
      <Grid grow pt={'lg'} style={{borderTop: '1px solid light-dark(var(--mantine-color-gray-2), var(--mantine-color-dark-5))'}}>
      <Grid.Col span={6}>
