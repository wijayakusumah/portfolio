  ...
  return (
    <Container size="lg" mt={60}>
      ...
      <Text fz="md" style={{ marginBottom: 'var(--mantine-spacing-xl)' }}>
        Below are some of the key projects I have worked on, each designed to create meaningful and
        positive change. These initiatives reflect my commitment to innovation, collaboration, and
        sustainability. Every project serves as a testament to my ability to transform ideas into
        impactful solutions.
      </Text>
      ...
      <Button leftSection={<IconCategoryPlus size={16} />} fullWidth component="a" href="/projects">
        Show All Projects
      </Button>
    </Container>
  );
